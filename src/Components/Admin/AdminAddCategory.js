...
import AddCategoryHook from "../../Hoock/category/AddCategoryHook"

const AdminAddCategory = () => {
    const  [img,name,isPressed,selectedFile,loading,onImageChange,handleSubmit,onChangeName] =AddCategoryHook()
